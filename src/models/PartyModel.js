...
const PartySchema = new mongoose.Schema({
  ...
  registrationId: { type: String }, // FDA Establishment ID, USDA cert#, company reg
  ...
  // Backward compatibility: link to existing role-specific profile document
  legacyRefCollection: { type: String }, // 'supplier_profiles', 'buyer_profiles', etc.
