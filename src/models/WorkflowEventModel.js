...
// Universal nonconformance, deviation, complaint, incident, and observation record.
// Initiatable from any workflow phase, questionnaire question, finding, or standalone.
// Collection: workflow_events
// CLAUDE DECISION: Named WorkflowEventModel (not EventModel) to avoid collision with
// the existing auditEventModel.js and the reserved 'Event' identifier.
...
const WorkflowEventSchema = new mongoose.Schema({
  ...
  workflowInstanceId: {
    type: mongoose.Schema.Types.ObjectId, ref: 'AuditRequestMaster',
    default: null, // null if raised standalone (outside a workflow)
  },
